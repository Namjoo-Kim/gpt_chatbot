...
class Main(FastAPI):
    def __init__(self, **extra: Any):
        ...
        self.add_api_route(
            path='/tdingbot',
            endpoint= self.tdingbot,
            methods=['POST']
        )

        self.add_api_route(
            path='/tdingDavinci',
            endpoint= self.tdingDavinci,
            methods=['POST']
        )

        self.add_api_route(
            path='/gongOwlclassification/{id}',
            endpoint= self.gongOwlclassification,
            methods=['POST']
        )
    ...
    def gongOwlclassification(self, gongowlModel: gongowlModel, id: str ):
        ...
        if result in ["입시", mes1, mes2]:
            ...
            # self.initGongowl.saveRsult(id, result)
            return "streaming"
    ...
    def stream(self, id: str):
        ...
        # return self.initGongowl.stream(id)
